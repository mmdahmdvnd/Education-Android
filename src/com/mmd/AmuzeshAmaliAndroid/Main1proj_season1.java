...
public class Main1proj_season1 extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.main1proj_season1);
		...
		nf7=(ImageView) findViewById(R.id.clear);
		...
		nf6.setOnClickListener(new OnClickListener(){
			public void onClick(View arg0) {
				...
				tempproj_season1.in=Integer.parseInt(show.getText().toString());
				
				Intent next=new Intent(Main1proj_season1.this,Main2proj_season1.class);
				startActivity(next);
		...
		nf7.setOnClickListener(new OnClickListener(){
			public void onClick(View arg0) {
	...
	protected void onResume() {
		...
		super.onResume();
		if(tempproj_season1.sw==true){
			
			show.setText(tempproj_season1.out+"");
